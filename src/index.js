      ...
      async function getUserLocaleInfo() {
        ...
        Geolocation.getCurrentPosition(
          ...
          async ({ coords: { latitude, longitude } }) => {
            ...
            var city = response.data.address.town;
            const result = await axios.get(
              'http://apiadvisor.climatempo.com.br/api/v1/locale/city?name='+city+'&state=SP&token=bacdc1142437e2f1455ba58466b170fd'
            );
            ...
            const finalResults = await axios.get(
              'http://apiadvisor.climatempo.com.br/api/v1/weather/locale/'+id+'/current?token=bacdc1142437e2f1455ba58466b170fd'
            );
        ...
        
        {
          results.data !== undefined  && (
            <View style={styles.cardContainer}>
              <Text style={styles.textStyle}>{results.name}, {results.state}</Text>
